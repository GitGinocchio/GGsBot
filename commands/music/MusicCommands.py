...
class MusicCommands(commands.Cog):
    ...
    @nextcord.slash_command('music_play',"Play songs with the bot in your channel!",default_member_permissions=2147483648,dm_permission=False)
    ...
    @nextcord.slash_command('music_stop',"Stop the current playing session!")
    async def stop(self, interaction : nextcord.Interaction):
        pass

    @nextcord.slash_command("music_join","Bring the bot on your current voice channel!",default_member_permissions=2147483648,dm_permission=False)
    ...
    @nextcord.slash_command('music_leave',"The bot will leave your vocal channel!",default_member_permissions=2147483648,dm_permission=False)
